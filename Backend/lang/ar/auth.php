...
return [
    ...
    */
    ...
    'technician_registered' => 'تم تسجيل الفني بنجاح.',
    'provider_registered' => 'تم تسجيل المورد بنجاح.',
    'tow_truck_registered' => 'تم تسجيل خدمة السطحة بنجاح.',
    ...
    'provider_registered_waiting_approval' => 'تم التسجيل بنجاح! حسابك قيد المراجعة، يرجى الانتظار حتى يتم ت فعيله من قبل الإدارة.',
    'profile_not_found' => 'الملف الشخصي غير موجود.',
    'role_not_authorized' => 'غير مصرح لك بتسجيل الدخول بهذا الدور.',
    'account_under_review' => 'حسابك قيد المراجعة من قبل الإدارة.',
