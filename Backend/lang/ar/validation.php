...
return [
    ...
    */
    ...
    'present_unless' => 'يجب أن يكون حقل :attribute موجودًا ما لم يكن :other في :values.',
    ...
    */
    ...
    'custom' => [
        ...
        'form_data' => [
            'required' => 'بيانات النموذج مطلوبة.',
            'array' => 'بيانات النموذج يجب أن تكون مصفوفة.',
        ],
        'form_data.category' => [
            'required' => 'الفئة مطلوبة.',
        ],
        'form_data.partDescription' => [
            'required' => 'وصف القطعة مطلوب.',
            'min' => 'وصف القطعة يجب أن يكون :min أحرف على الأقل.',
        ],
        'form_data.city' => [
            'required' => 'المدينة مطلوبة.',
        ],
        'form_data.contactMethod' => [
            'required' => 'طريقة التواصل مطلوبة.',
            'in' => 'طريقة التواصل غير صالحة.',
        ],
        'form_data.partTypes' => [
            'required' => 'أنواع القطع مطلوبة.',
            'array' => 'أنواع القطع يجب أن تكون مصفوفة.',
        ],
        'price' => [
