...
import { useSendOtp, useVerifyOtp, useResetPassword } from '@/hooks';
...
export const ForgotPasswordScreen: React.FC<ForgotPasswordScreenProps> = ({
    ...
    const handleResetPassword = async () => {
        ...
        try {
            await resetPassword.mutateAsync({ phone, password });
            onSuccess?.();
        } catch (error: any) {
            setErrors({ general: error.response?.data?.message || 'فشل إعادة تعيين كلمة المرور' });
        }
    };
    ...
    const renderPhoneStep = () => (
        <View style={styles.stepContainer}>
            <Text style={styles.stepTitle}>استعادة كلمة المرور</Text>
            <Text style={styles.stepSubtitle}>أدخل رقم جوالك لإرسال رمز التحقق</Text>
    ...
    const renderPasswordStep = () => (
        <View style={styles.stepContainer}>
            <Text style={styles.stepTitle}>كلمة المرور الجديدة</Text>
            <Text style={styles.stepSubtitle}>أدخل كلمة المرور الجديدة</Text>
        ...
        >
            ...
            >
                ...
                <View style={styles.logoContainer}>
                    ...
                    <Text style={styles.subtitle}>استعادة كلمة المرور</Text>
                </View>
