...
const initialNotificationSettings: NotificationSettings = {
    ...
    PROVIDER_INACTIVITY_ADMIN: true, WITHDRAWAL_REQUEST_ADMIN: true, NEW_PROVIDER_REGISTRATION: true,
    NEW_TECHNICIAN_REGISTRATION: true,
    NEW_TOW_TRUCK_REGISTRATION: true,
    NEW_FLASH_PRODUCT_REQUEST: true,
    NEW_CAR_PROVIDER_REQUEST: true,
    NEW_ANNOUNCEMENT_CAR_PROVIDER: true,
    NEW_PROVIDER_REQUEST: true,
    NEW_TECHNICIAN_REQUEST: true,
    NEW_TOW_TRUCK_REQUEST: true,
    CAR_PROVIDER_VERIFIED: true,
