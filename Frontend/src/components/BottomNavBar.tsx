                        ...
                        return (
                            <div key={item.id} className="relative -top-6 flex justify-center">
                                ...
                                <button
                                    ...
                                    className="flex items-center justify-center w-14 h-14 rounded-full bg-[#f3efe4] text-slate-900 shadow-lg shadow-slate-400/30 hover:scale-105 hover:shadow-slate-400/40 active:scale-95 transition-all duration-300 ring-4 ring-white dark:ring-slate-900"
