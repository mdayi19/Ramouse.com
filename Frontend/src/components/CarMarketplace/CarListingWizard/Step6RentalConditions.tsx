...
const Step6RentalConditions: React.FC<Step6RentalConditionsProps> = ({
    ...
    const rentalTermsSuggestions = [
        { id: 'insurance_required', label: 'تأمين مُسبق مطلوب', icon: '🛡️' },
        { id: 'valid_license', label: 'رخصة قيادة سارية', icon: '📋' },
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {rentalTermsSuggestions.map((term) => (
                        <button
                            ...
                            className={`flex items-center gap-3 p-4 rounded-xl transition-all text-right ${isTermSelected(term.id)
