...
const ContactScreen: React.FC<ContactScreenProps> = ({ onBack, settings, showToast }) => {
  ...
  const contactSchema = {
    ...
    "@type": "ContactPage",
    "name": "اتصل بنا | راموسة",
    "description": "تواصل مع فريق دعم راموسة عبر الهاتف أو البريد الإلكتروني.",
    "url": "https://ramouse.com/contact",
    "mainEntity": {
      "@type": "Organization",
      "name": "Ramouse.com",
  ...
  return (
    <div className="w-full animate-fade-in bg-white dark:bg-darkcard rounded-xl shadow-lg p-6 sm:p-8">
      <SEO
        title="تواصل معنا | راموسة"
        description="تواصل مع فريق خدمة عملاء راموسة. نحن هنا للمساعدة في استفساراتكم حول بيع وشراء السيارات، قطع الغيار، والصيانة."
        canonical="/contact"
      />
      <SeoSchema type="ContactPage" data={contactSchema} />
